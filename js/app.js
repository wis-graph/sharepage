import { navigate, initRouter } from './router.js?v=8888';
import { BASE_PATH, IS_LOCAL } from './utils.js?v=8888';
import { initTOCToggle } from './toc.js?v=8888';
import { goToPage } from './dashboard.js?v=8888';
